...
public class BoardDAO {
	...
	static final private String SQL_INSERT="INSERT INTO BOARD (TITLE,ARTIST,WRITER) VALUES(?,?,?)";
	static final private String SQL_UPDATE="UPDATE BOARD SET TITLE=?,ARTIST=? WHERE NUM=?";
	...
	public boolean insert(BoardVO bVO) {
		...
		try {
			...
			pstmt.setString(2, bVO.getArtist());
